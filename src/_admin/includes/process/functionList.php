        ...
        if (isset($_SESSION['user_id'])
		    ...
		    && isset($_SESSION['user_role'])){
                ...
                if (strcmp($_SESSION['user_ip'],$_SERVER['REMOTE_ADDR'])==0
                    && strcmp($_SESSION['user_browser'],$_SERVER['HTTP_USER_AGENT'])==0
                )
                return true;
            }
...
function checkPassword($thePassword) {
    ...
    if (strlen($thePassword) < 6) {
        return "Password length has to be 6 characters or more.";
    }

    if (!preg_match("#[0-9]+#", $thePassword)) {
        return "Password must include at least one number.";
    }

    if (!preg_match("#[a-zA-Z]+#", $thePassword)) {
